...
async def on_member_join(member):
    await member.send("Welcome, gentlemen (or gentlewoman or gentleperson), to Aperture Science. Astronauts, war heroes, Olympians--you're here because we want the best, and you are it. So: Who is ready to make some science? If that's you, take a look at our wiki found here: https://github.com/schmoomers/Schmoomer-s-Wiki/wiki. Additionally, take a look at our <#" + faq + "> and the <#" + welcome + "> channels for some help and rules around here.")
